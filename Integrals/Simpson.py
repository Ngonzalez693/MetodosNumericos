...
def Simpson(a,b,n,f):
    ...
    print("Integral por Simpson 1/3: ",integral)

# Simpson n intervals

def nSimpson(a,b,n,f):
    ...
    print("Integral por Simpson 1/3 con n intervalos: ",integral)

# Simpson 3/8

def Simpson3(a,b,n,f):
